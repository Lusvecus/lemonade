...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        if (!message.member.voice.channel) return client.sendTime(message.channel, "ต้องเข้าช่องทที่จะฟังเพลงก่อน🍋");
        if(!message.member.voice.channel.permissionsFor(message.guild.me).has("CREATE_INSTANT_INVITE"))return client.sendTime(message.channel, "เลม่อน🍋 ไม่มีสิทธิ์สร้างคำเชิญ;-;");
...
`)
     ...
     */
        run: async (client, interaction, args, { GuildDB }) => {
            ...
            if(!member.voice.channel.permissionsFor(guild.me).has("CREATE_INSTANT_INVITE"))return client.sendTime(interaction, "เลม่อน🍋 ไม่มีสิทธิ์สร้างคำเชิญ;-;");
